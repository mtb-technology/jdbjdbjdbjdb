...
export function registerPromptRoutes(app: Express): void {
   ...
   */
  app.get("/api/prompts/active", asyncHandler(async (req: Request, res: Response) => {
  ...
  app.put("/api/prompts/:id", asyncHandler(async (req: Request, res: Response) => {
    ...
    if (!updatedConfig) {
      throw ServerError.notFound("Prompt configuratie");
    }
   ...
   */
  app.get("/api/prompts/backup", asyncHandler(async (req: Request, res: Response) => {
   ...
   */
  app.post("/api/prompts/restore", asyncHandler(async (req: Request, res: Response) => {
    ...
    if (data.prompt_configs && Array.isArray(data.prompt_configs)) {
      ...
      throw ServerError.validation("Invalid backup format", "Ongeldig backup formaat");
    }
