...
export const PROMPT_STAGES: readonly PromptStage[] = [
  ...
  { key: "7_fiscale_briefing", label: "7. Fiscale Briefing", description: "Executive summary voor fiscalist → JSON briefing", type: "generator" },
  { key: "editor", label: "Editor (Chirurgische Redacteur)", description: "Past wijzigingen van reviewers toe op rapport", type: "generator" },
  { key: "adjustment", label: "Rapport Aanpassen", description: "Genereert JSON aanpassingen (zoals reviewers) - ook voor Extern Rapport tab", type: "generator" },
] as const;
