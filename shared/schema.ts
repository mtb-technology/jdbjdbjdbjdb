...
// ═══════════════════════════════════════════════════════════════════════════
// BOX 3 V1 - LEGACY (REMOVED)
// ═══════════════════════════════════════════════════════════════════════════
// V1 box3ValidatorSessions table and all related types have been removed.
// The V2 system uses box3Dossiers, box3Documents, and box3Blueprints tables.
// See BOX 3 V2 section below for the new canonical data model.
...
// ═══════════════════════════════════════════════════════════════════════════
// BOX 3 V2 - RE-EXPORTED FROM SEPARATE MODULE
// ═══════════════════════════════════════════════════════════════════════════
// All Box 3 related schemas, types, and tables are defined in ./schema/box3.ts
...
export {
  ...
  type Box3DataPoint,
  type Box3Person,
  type Box3FiscalEntity,
  type Box3OwnerRef,
  type Box3BankSavingsAsset,
  type Box3InvestmentAsset,
  type Box3RealEstateAsset,
  type Box3OtherAsset,
  type Box3Assets,
  type Box3Debt,
  type Box3TaxAuthorityPersonData,
  type Box3TaxAuthorityYearData,
  type Box3CompletenessStatus,
  type Box3YearStatus,
  type Box3MissingItem,
  type Box3CalculatedTotals,
  type Box3YearSummary,
  type Box3ValidationFlag,
  type Box3ManualOverrideV2,
  ...
  box3DataPointSchema,
  box3PersonSchema,
  box3FiscalEntitySchema,
  box3DocumentClassificationSchema,
  box3YearSummarySchema,
  box3SourceDocumentEntrySchema,
  box3BlueprintPartialSchema,

  // Database types
  type Box3Dossier,
  type InsertBox3Dossier,
  type Box3Document,
  type InsertBox3Document,
  type Box3BlueprintRecord,
  type InsertBox3BlueprintRecord,

  // Insert schemas
  insertBox3DossierSchema,
  insertBox3DocumentSchema,
  insertBox3BlueprintSchema,

  // Helper functions
  createEmptyBox3Blueprint,
} from "./schema/box3";
